...
console.log(`1 - chromiumExecutablePath: ${chromiumExecutablePath}`);
...
console.log(`2 - chromiumExecutablePath: ${chromiumExecutablePath}`);
...
exports.get_phones_google = async (search_query) => {
  ...
  try {
    ...
    */
    ...
    console.error(err);
    searchResults = { error: true, q: g_uri };
  }
  await browser.close();
